...
const VIDEO_DATA = [
  ...
  { nickname: "Tre Williams",   comment: "That mid-range jumper is automatic 💯 #buckets",               trackName: "A-Team",                   artistName: "Travis Scott",              coverUrl: "/covers/a_team.webp",            userpic: "/avatars/pic6.webp", badgeName: "Schooled",    badgeIconBg: "#0055FF" },
  ...
  { nickname: "@elevate_6ft",   comment: "Every single layup was different 🤯 #highlights #hoops",      trackName: "I Ain't Got Time!",        artistName: "Tyler, The Creator",        coverUrl: "/covers/i_aint_got_time.webp",   userpic: "/avatars/pic6.webp", badgeName: "Beast Mode",  badgeIconBg: "#1a7f37" },
